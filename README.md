...
- In the Office client application, choose the Home tab, and then choose the Benz button in the ribbon to open the add-in task pane. The following image shows this button in Excel.
